...
/**
 * Базовый интефейс слоя DAO с CRUD операциями. Его главное отличие от
 * интерфейса {@link ru.nick.bo.SimpleCrudBusinessObject} в семантике. И для
 * будущиx изменений, весьма удобно иметь на каждом слое отдельный интерфейс
 * 
 * @author NovikovNick
 *
 * @param <T>
