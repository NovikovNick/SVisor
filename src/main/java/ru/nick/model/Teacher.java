...
/**
 * Класс содержит всю информацию про преподавателя, включая - свою ученую
 * степень {@link AcademicDegree} и ученое звание {@link AcademicTitle}, списки
 * дисциплин {@link Discipline} и групп {@link Group}
 * 
 * @author NovikovNick
 *
 */
